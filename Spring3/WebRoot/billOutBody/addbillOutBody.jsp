...
<div id="content">
			...
			<div class="right-nav">
					<ul>
							<li><img src="images/home.png"></li>
								<li style="margin-left:25px;">您当前的位置：填写商品出库单</li>
	...
	<center>
   <form action="billOutBody/addbillOutBody.action" method="post">
   <table border="1">
   <tr>
   <td>时间：<input type="text" name="billOutHead.createTime"/></td>
   ...
   <td>商品名：<input type="text" name="billOutBody.goodsName"/></td>
    <td>数量：<input type="text" name="billOutBody.number"/></td>
