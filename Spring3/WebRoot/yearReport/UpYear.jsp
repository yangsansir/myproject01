...
<div id="content">
    ...
    <s:hidden name="yearReport.id"/>
    <table>
    <tr>
    <td>支出项：</td>
     <td>
      <s:textfield name="yearReport.yearPay"/>
     
    </tr>
    <tr>
    <td>支出费用：</td>
     <td> 
      <s:textfield name="yearReport.yearPayCount"/>
    
    </tr>
    <tr>
    <td>收入项：</td>
     <td>
      <s:textfield name="yearReport.yearIncome"/>
  
    </tr>
    <tr>
    <td>收入费用：</td>
     <td> 
       <s:textfield name="yearReport.yearIncomeCount"/>
