...
<div id="content">
	<div class="left_menu">
      ...
      <li>
			...
			<div class="right-nav">
					<ul>
							<li><img src="images/home.png"></li>
								...
								<li><a href="#">系统公告</a></li>
								<li></li>
								<li><a href="salary/addSalary.jsp">供应商管理</a></li>
						</ul>
		...
		<s:if test="#session.supplierlist==null" >
		              没有任何记录！
		
		</s:if>
		<s:else >
		<s:iterator value="#session.supplierlist" var="checkUser"  >
			<tr>
				<td>${id}</td>
...
<td>${remark}</td>
				...
				<td><a href="supplier/findById.action?id=${id}">修改</a> <a
					href="supplier/delete.action?id=${id}">删除</a>
