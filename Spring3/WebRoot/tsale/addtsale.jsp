...
<div id="content">
	...
	<center>
   <form action="tsale/add.action" method="post">
  <table border="1" cellspacing="0" cellpadding="10">
  <tr>
  <td>商品名称<label style="color: red">*</label></td>
  <td> <input type="text" name="tsale.goods"/><br></td>
  </tr>
   <tr>
  <td>商品别称<label style="color: red">*</label></td>
  <td> <input type="text" name="tsale.num"/><br></td>
  </tr>
  
   <tr>
  <td>售价<label style="color: red">*</label></td>
  <td> <input type="text" name="tsale.price"/><br></td>
  </tr>
  <tr>
  <td>特价<label style="color: red">*</label></td>
  <td> <input type="text" name="tsale.tprice"/><br></td>
  </tr>
