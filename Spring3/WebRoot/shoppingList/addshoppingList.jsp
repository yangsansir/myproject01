...
<div id="content">
	...
	<center>
    <form action="shoppingList/add.action" method="post">
   <table border="1" cellspacing="0" cellpadding="10">
  <tr><td>物品名称：</td>
 <td><input type="text" name="shoppingList.GoodsName"/> </td>
 </tr>
   <tr>
   <td>物品类型：</td>
   <td><input type="text" name="shoppingList.goodsType"/></td>
 </tr>
 <tr><td>物品数量：</td>
 <td><input type="text" name="shoppingList.number"/> </td>
 </tr>
 <tr><td> 物品价格：</td>
 <td><input type="text" name="shoppingList.price"/> </td>
 </tr>
