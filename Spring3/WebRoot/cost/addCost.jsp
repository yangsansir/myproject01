...
<div id="content">
	<div class="left_menu">
	  ...
	  <center>
<h3> 住户缴费单</h3> 
  <form action="houseHoldBill/addHouseHoldBill.action" method="post"> 
    <table border="1" cellpadding="10" cellspacing="0">
    <tr>
    <td>户主姓名:<input type="text" name="houseHoldBill.RealName" value='<s:property value='residernt.RealName'/>'/></td>
    <td></td>
    ...
    <td>费用：<input type="text" name="singlePayment.Cost"/></td>
