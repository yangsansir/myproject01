...
<div id="content">
	...
	<center>
   <form action="warehouse/add.action" method="post">
  <table border="1" cellspacing="0" cellpadding="10">
  <tr>
  <td>仓库名称<label style="color: red">*</label></td>
  <td> <input type="text" name="warehouse.warehouseName"/><br></td>
  </tr>
   <tr>
  <td>拼音码<label style="color: red">*</label></td>
  <td> <input type="text" name="warehouse.pyCode"/><br></td>
  </tr>
   <tr>
  <td>地址<label style="color: red">*</label></td>
  <td> <input type="text" name="warehouse.location"/><br></td>
  </tr>
   <tr>
  <td>描述<label style="color: red">*</label></td>
  <td> <input type="text" name="warehouse.description"/><br></td>
  </tr>
  </table>
