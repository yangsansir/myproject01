...
<div id="content">
	...
	<center>
    <form action="goodsRepair/add.action" method="post">
   <table border="1" cellspacing="0" cellpadding="10">
  <tr><td>物品名称：</td>
 <td><input type="text" name="goodsRepair.goodsName"/> </td>
 </tr>
   <tr>
   <td>维修原因：</td>
   <td><input type="text" name="goodsRepair.reason"/></td>
 </tr>
 <tr><td>维修费用：</td>
 <td><input type="text" name="goodsRepair.repairCost"/> </td>
 </tr>
