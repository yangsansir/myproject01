...
<div id="content">
    ...
    <form action="monthReport/add.action" method="post">
    <table>
    <tr>
    <td>支出项：</td>
     <td><input name="monthReport.monthPay" type="text" id="form" size="22" /></td>
    </tr>
    <tr>
    <td>支出费用：</td>
     <td> <input name="monthReport.monthPayCount" type="text" id="fax" size="22" /></td>
    </tr>
    <tr>
    <td>收入项：</td>
     <td><input name="monthReport.monthIncome" type="text" id="form" size="22" /></td>
    </tr>
    <tr>
    <td>收入费用：</td>
     <td> <input name="monthReport.monthIncomeCount" type="text" id="fax" size="22" /></td>
    </tr>
    <tr>
    <td>小区：</td>
