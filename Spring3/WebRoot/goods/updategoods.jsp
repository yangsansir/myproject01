...
<div id="content">
	<div class="left_menu">
     ...
     <input type="text" name="goods.id" value='<s:property value='goods.id'/>'/>
  <table border="1" cellspacing="0" cellpadding="10">
  <tr>
  <td>商品名称<label style="color: red">*</label></td>
  <td> <input type="text" name="goods.goodsName" value="<s:property value='goods.goodsName'/>"/><br></td>
  </tr>
   <tr>
  <td>商品别称<label style="color: red">*</label></td>
  <td> <input type="text" name="goods.goodsNickName" value="<s:property value='goods.goodsNickName'/>"/><br></td>
  </tr>
  <tr>
  ...
  <td> <input type="text" name="goods.producer" value="<s:property value='goods.producer'/>"/><br></td>
  </tr>
   <tr>
  <td>售价<label style="color: red">*</label></td>
  <td> <input type="text" name="goods.salePrice" value="<s:property value='goods.salePrice'/>"/><br></td>
  </tr>
  <tr>
  <td>生产日期<label style="color: red">*</label></td>
  <td> <input type="text" name="goods.productDate" value="<s:property value='goods.productDate'/>"/><br></td>
  </tr>
   <tr>
  <td>保质截止期<label style="color: red">*</label></td>
  <td> <input type="text" name="goods.endDate" value='<s:property value='goods.endDate'/>'/><br></td>
  </tr>
