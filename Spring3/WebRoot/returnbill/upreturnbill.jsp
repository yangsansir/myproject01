...
<div id="content">
  ...
  <td> <input type="text" name="returnBill.goods" value="<s:property value='#returnBill.goods'/>"/><br></td>
  </tr>
   <tr>
  <td>数量<label style="color: red">*</label></td>
  <td> <input type="text" name="returnBill.goodsnnum" value="<s:property value='#returnBill.goodsnnum'/>"/><br></td>
  </tr>
