...
<div id="content">
	<div class="left_menu">
			...
			<div class="right-nav">
					<ul>
							<li><img src="images/home.png"></li>
								<li style="margin-left:25px;">您当前的位置：管理进货单</li>
								<li><a href="#"></a></li>
								<li></li>
								<li><a href="#"></a></li>
						</ul>
	  ...
	  <center> <table border="1" cellspacing="0" cellpadding="10">
		...
		<s:if test="#session.carPaymentlist==null" >
		              没有任何记录！
		
		</s:if>
		<s:else >
		<s:iterator value="#session.carPaymentlist" var="carPayment"  >
			<tr>
				<td>${carPayment.id}</td>
				<s:iterator value="#carPayment.carHoldBill">
				
				<td>${createTime}</td>
				
			 
				</s:iterator>
				<s:iterator value="#carPayment.checkUser">
			...
			<td>${number}</td>
			<td>${status}</td>
				<td><a href="carPayment/findById1.action?id=${id}">修改</a> <a
					href="carPayment/delete.action?id=${id}">删除</a>
