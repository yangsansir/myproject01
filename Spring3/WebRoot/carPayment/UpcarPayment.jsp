...
<div id="content">
    ...
    <form action="carPayment/update.action" method="post">
   ...
   <table border="1">
   <tr>
   <td>时间：<input type="text" name="carHoldBill.createTime" value='<s:property value='carPayment.carHoldBill.createTime'/>'/></td>
   ...
   <td>商品名：<input type="text" name="carPayment.goodsName" value='<s:property value='carPayment.goodsName'/>'/></td>
    <td>数量：<input type="text" name="carPayment.number" value='<s:property value='carPayment.number'/>'/></td>
