...
<div id="content">
	...
	<center>
    <form action="singlePayment/addsinglePayment.action" method="post">
   <table border="1">
   <tr>
   <td>时间：<input type="text" name="houseHoldBill.createTime"/></td>
   ...
   <td>商品名：<input type="text" name="singlePayment.goodsName"/></td>
    <td>数量：<input type="text" name="singlePayment.number"/></td>
