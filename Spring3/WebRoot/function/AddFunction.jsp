...
<div id="content">
	<div class="left_menu">
      ...
      <li>
		...
		<div class="m-right">
		 ...
		 <center>
   <form action="function/addFunction.action" method="post">
   ...
   <tr><td>  功能：</td>
   <td><input type="text" name="function.FunctionName"/><br></td>
   
   </tr>
    
   <tr><td>url：</td>
   <td> <input type="text" name="function.Url"/><br></td>
   
   </tr>
    <tr><td><s:submit value="添加" /></td>
