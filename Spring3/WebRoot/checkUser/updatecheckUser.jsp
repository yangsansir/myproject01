...
<div id="content">
	<div class="left_menu">
      ...
      <li>
		...
		<center>
    <form action="checkUser/update.action" method="post">
    <input type="hidden" name="checkUser.id" value='<s:property value='checkUser.id'/>'/>
  <table border="1" cellspacing="0" cellpadding="10">
  <tr>
  <td>检验员名称</td>
  <td> <input type="text" name="checkUser.checkUserNmae" value='<s:property value='checkUser.checkUserNmae'/>'/><br></td>
  </tr>
