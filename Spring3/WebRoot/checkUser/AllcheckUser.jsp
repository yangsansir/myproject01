...
<div id="content">
	<div class="left_menu">
      ...
      <li>
		...
		<s:if test="#session.checkUserlist==null" >
		              没有任何记录！
		
		</s:if>
		<s:else >
		<s:iterator value="#session.checkUserlist" var="checkUser"  >
			<tr>
				<td width="80px">${id}</td>
				<td width="100px">${checkUserNmae}</td>
			
			
				<td><a href="checkUser/findById.action?id=${id}">修改</a> <a
					href="checkUser/delete.action?id=${id}">删除</a>
