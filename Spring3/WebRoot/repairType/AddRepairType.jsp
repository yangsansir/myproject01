  ...
  <head>
   ...
   <script type="text/javascript" src="<%=basePath%>js/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="<%=basePath%>js/menu.js"></script>
     <script type="text/javascript" src="<%=basePath%>js/repairType.js"></script>
  </head>
...
<div id="content">
	<div class="left_menu">
	 ...
	 <center><form action="repairType/add.action" method="post">
   维修类型：<input type="text" name="repairType.RepairType"/><input type="button" value="添加更多"  id="btn"/><br/>
