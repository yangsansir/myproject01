	...
	<div class="left_menu">
      ...
      <li>
		...
		<table border="1" cellspacing="0" cellpadding="10">
			...
			<s:iterator value="#session.repairTypelist" var="RepairType">
			<tr>
				<td>${id}</td>
				<td>${RepairType}</td>
				<td><a href="repairType/findById.action?id=${id}">修改</a> <a
					href="repairType/delete.action?id=${id}">删除</a>
					<a
					href="repairType/AddRepairType.jsp">添加</a>
					</td>
			</tr>
			</s:iterator>
		</table>
